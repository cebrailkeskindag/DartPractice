...
void main(){
  var o1 = Ogrenciler(no: 543, ad: "Ali", sinif: "9B");
  var o2 = Ogrenciler(no: 258, ad: "Mehmet", sinif: "11D");
  var o3 = Ogrenciler(no: 384, ad: "Sude", sinif: "10D");
  ...
  Iterable<Ogrenciler> f1 = ogrencilerListesi.where((ogrenciNesnesi){
    return ogrenciNesnesi.no > 100 && ogrenciNesnesi.no < 450;
  });
  ...
  Iterable<Ogrenciler> f2 = ogrencilerListesi.where((ogrenciNesnesi){
    return ogrenciNesnesi.ad.contains("hm");
  });
